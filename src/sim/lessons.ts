...
export const lessonSpecs: LessonSpec[] = [
  {
    ...
    effect: 'Reliability +5, scales | Lightness -3',
    maxStacks: 10,
  ...
  },
  {
    ...
    effect: 'Thrust +5, scales | Reliability -3',
    maxStacks: 10,
  },
  {
    id: 'improveFuelFlow',
    ...
    effect: 'Fuel +5, scales | Reliability +1',
    maxStacks: 10,
  ...
  },
  {
    ...
    effect: 'Guidance +5, scales | Aerodynamics +2 | Lightness -2',
    maxStacks: 8,
  ...
  },
  {
    ...
    effect: 'Aerodynamics +5, scales | Guidance +1',
    maxStacks: 8,
  ...
  },
  {
    ...
    effect: 'Lightness +6, scales | Reliability -3',
    maxStacks: 8,
    unlock: 'blackBoxRecovery',
  },
  {
  ...
  },
  {
    ...
    effect: 'Guidance +7, scales | Reliability +4, scales',
    maxStacks: 1,
